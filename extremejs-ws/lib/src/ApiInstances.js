...
var ExtremeApi = require("./ExtremeApi");
...
class ApisInstance {
    ...
    connect( cs ) {
        ...
        this.init_promise = this.ws_rpc.login(rpc_user, rpc_password).then(() => {
            ...
            this._db = new ExtremeApi(this.ws_rpc, "database");
            this._net = new ExtremeApi(this.ws_rpc, "network_broadcast");
            this._hist = new ExtremeApi(this.ws_rpc, "history");
            this._crypt = new ExtremeApi(this.ws_rpc, "crypto");
