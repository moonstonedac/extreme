...
import {PrivateKey, Address, Aes, PublicKey, hash} from "extremejs-lib";
import {Apis, ChainConfig} from "extremejs-ws";
...
export default class ImportKeys extends Component {
    ...
    /** XTR 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // XTR 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    XTR 1.0 hosted wallet backup (wallet.extreme.org) is supported.

    XTR 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function (pubkey, account_name) {
            ...
            address = "XTR" + address.substring(3);
        ...
        try {
            ...
            if( ! encrypted_brainkey)
                throw "Please use a XTR 1.0 wallet_export_keys file instead";
