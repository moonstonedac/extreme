...
import {ChainStore, ChainValidation} from "extremejs-lib";
        ...
        return (
            <div>
                ...
                <label><Translate content="account.user_issued_assets.force_settlement_offset_percent" />
                    <input type="number" value={smartasset_opts.force_settlement_offset_percent / assetConstants.EXTREME_1_PERCENT} onChange={this.props.onUpdate.bind(this, "force_settlement_offset_percent")}/>
                </label>

                <label><Translate content="account.user_issued_assets.maximum_force_settlement_volume" />
                    <input type="number" value={smartasset_opts.maximum_force_settlement_volume / assetConstants.EXTREME_1_PERCENT} onChange={this.props.onUpdate.bind(this, "maximum_force_settlement_volume")}/>
                </label>
    ...
    resetState(props) {
        ...
        return {
            ...
            smartasset_opts: {
                ...
                "force_settlement_offset_percent" : 1 * assetConstants.EXTREME_1_PERCENT,
                "maximum_force_settlement_volume" : 20 * assetConstants.EXTREME_1_PERCENT,
    ...
    onChangeSmartAssetOpts(value, e) {
        ...
        switch (value) {
            ...
            case "maximum_force_settlement_volume":
                smartasset_opts[value] = parseFloat(e.target.value) * assetConstants.EXTREME_1_PERCENT;
                break;
