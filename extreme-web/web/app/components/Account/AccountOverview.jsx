...
import {ChainStore} from "extremejs-lib";
    ...
    _renderBalances(balanceList) {
        ...
        balanceList.forEach( balance => {
            ...
            if (asset) {
                ...
                let preferredMarket = market ? market : core_asset ? core_asset.get("symbol") : "XTR";
                ...
                <ul>
                    ...
                    <li>{marketLink}</li>
                    {isSmartAsset ? <li>{settleLink}</li> : null}
                </ul>);
            }
                        ...
                        <ActionSheet>
                            ...
                            <ActionSheet.Content >
                                <ul className="no-first-element-top-border">
                                    ...
                                    {isSmartAsset ? <li className="dropdown-options">
                                        {settleLink}
                                    </li> : null}
                                </ul>
                            </ActionSheet.Content>
