...
Daha önce bahsedildiği gibi , Extreme sadece bir *teknolojiyi* yada *protokolü* 
tarif etmektedir. Fakat fiilen bir  ekosisteme dönüşmesi  Extreme gibi 
gerçek bir blokzinciri ile birlikte mümkün olur.

Extreme , blokzinciri yeniliğini , hizmetlerini internet kullanarak sunan tüm 
...
Bitcoin para için ne yaptıysa Extreme'de işletmeler için onu yapar. Bunu , evrensel, 
şeffaf, güvenilir, verimli ve karlı şirketler yaratmak için dağıtık mutabakat teknolojisini 
kullanarak yapar.

## Bu Cüzdan

Şu an bu tarayıcı penceresinde açık olan cüzdanla Extreme ağının tüm işlevlerine
erişebilirsiniz.
