...
Extreme-UI is open source and anyone is free to contribute. PR's are welcomed and will be reviewed in a timely manner, and long-term contributors will be given access to the repo.
...
- Project Coordinator announces release on extremetalk and provides link to release notes
