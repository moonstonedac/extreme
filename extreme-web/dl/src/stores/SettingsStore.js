...
const CORE_ASSET = "XTR"; // Setting this to XTR to prevent loading issues when used with XTR chain which is the most usual case currently

const STORAGE_KEY = "__extreme__";
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "en",
            apiServer: "wss://xtrnode.moonstonedac.com",
            faucet_address: "http://xtrfaucet.moonstonedac.com:22001",
            unit: CORE_ASSET,
            showSettles: false,
        ...
        let apiServer = [
            {url: "wss://xtrnode.moonstonedac.com", location: "Master Node"},
            {url: "wss://xtrnode1.moonstonedac.com", location: "Node 1"},
            {url: "wss://xtrnode2.moonstonedac.com", location: "Node 2"},
            {url: "wss://xtrnode3.moonstonedac.com", location: "Node 3"},
            {url: "wss://xtrnode4.moonstonedac.com", location: "Node 4"},
            {url: "wss://xtrnode5.moonstonedac.com", location: "Node 5"},
            {url: "wss://xtrnode6.moonstonedac.com", location: "Node 6"},
            {url: "wss://xtrnode7.moonstonedac.com", location: "Node 7"},
            {url: "wss://xtrnode8.moonstonedac.com", location: "Node 8"},
            {url: "wss://xtrnode9.moonstonedac.com", location: "Node 9"},
          ];
